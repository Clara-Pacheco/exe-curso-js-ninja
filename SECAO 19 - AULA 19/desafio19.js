  (function(){ 
    ...
    */
    ...
    // O método que retorna um array com as matchs entre o texto dado e a regex é o método .match
    
    // É feito o casamento entre o texto e a regex passada como parâmetro, e retornado um array
    // com os matchs encontrados entre a regex e o texto.
    ...
    */
    ...
    // TUDO QUE FOR UTILIZAR EM JS, SEMPRE DAR PREFERÊNCIA PARA OS LITERAIS -
    // FAZER UMA REGEX LITERAL, UM OBJETO LITERAL, UM ARRAY LITERAL (TUDO MANUAL) ETC...
    // AO INVÉS DE USAR O CONSTRUTOR.
    ...
    */
    ...
    marcação HTML.
    - Primeiro, crie uma função chamada `hasClass`; OK
    ...
    */
    ...
    function hasClass(markup,cssClass){
      const regex = new RegExp('class=["\'](?:[\\w\\s]+)?' + cssClass + '(?:[\\w\\s]+)?["\']');
      return regex.test(markup);
    }


    let arrayClasses = ['container', 'text', 'date', 'excerpt', 'main'];	
    arrayClasses.forEach(function(cssClass){
