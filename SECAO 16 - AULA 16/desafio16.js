(function (){
  'use strict'
    ...
    */
    ...
    let nameString =   nameArray.toString();
    let firstPart = nameString.slice(0,22);
    let finalPart = firstPart + ' e ' + nameString.slice(23) +' são meus amigos.'

    let nameArray2 = ['Clara','Lara','Paulo','Lauro','João'];
    let newSlice = nameArray2.slice(nameArray2[length-3], nameArray2[length-1]);
    let nameString2 =   nameArray2.toString();



    let firstPart2 = nameString2.slice(0,22);
    let finalPart2 = firstPart2 + ' e ' + nameString2.slice(23) +' são meus amigos.'
    ...
    */
    ...
    let partFernando = nameFernando.substring(7,1)
