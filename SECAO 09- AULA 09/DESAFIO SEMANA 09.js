(function (){
        ...
        */
        ...
        chamada.
        */
        console.log( 'O resultado da subtração é:', subtraction(function callback(num1, num2){return num1-num2;}));
        // ?

        console.log( 'O resultado da multiplicação é:', multiplication(function callback(num1, num2){return num1 * num2;}));
        // ?

        console.log( 'O resultado da divisão é:', division(function callback(num1, num2){return num1 / num2;}));
        // ?

        console.log( 'O resto da divisão é:', mod(function callback(num1, num2){return num1 % num2;}));
        // ?
